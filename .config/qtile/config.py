...
keys = [
    ...
    Key([mod], "space", lazy.spawn("fuzzel"), desc="Move focus to left"),
    Key([mod], "b", lazy.spawn("firefox"), desc="Move focus to left"),
...
layouts = [
    layout.Columns(
        border_focus_stack=["#fff", "#fff"], 
        border_focus=["#fff", "#fff"], 
        border_width=2,
        margin=1,
    ),
    layout.Max(),
...
logo = "~/Pictures/Wallpapers/1381020.png"
screens = [
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Clock(format="⏱️ %Y-%m-%d %a %I:%M %p"),
                widget.QuickExit(
                    default_text = "  ⚡"
